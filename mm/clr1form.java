...
public class clr1form extends JFrame {
	...
	public clr1form() {
		...
		button.addActionListener(new ActionListener() {
			...
			private void handleGrammar(ActionEvent e) {
				 if(parserKind.equals("LR(0)") || parserKind.equals("SLR(1)")){
			            clr1output.setText(lr0Parser.getGrammar()+"");
			        }else{
			            clr1output.setText(lr1Parser.getGrammar()+"");
			        }
			}
		});
		...
		JTextArea clr1input = new JTextArea();
		scrollPane.setViewportView(clr1input);
		...
		scrollPane_1.setViewportView(clr1output);
		...
		button_1.setBounds(145, 156, 89, 23);
		...
		button_2.setBounds(244, 156, 89, 23);
		...
		button_3.addActionListener(new ActionListener() {
			...
			private void handleState(ActionEvent e) {
				if(parserKind.equals("LR(0)") || parserKind.equals("SLR(1)")){
		            clr1output.setText(lr0Parser.canonicalCollectionStr());
		        }else{
		            clr1output.setText(lr1Parser.canonicalCollectionStr());
		        }
			}
		});
		button_3.setBounds(343, 156, 89, 23);
		...
		button_4.addActionListener(new ActionListener() {
			...
			private void handleGoTo(ActionEvent e) {
				if(parserKind.equals("LR(0)") || parserKind.equals("SLR(1)")){
		            clr1output.setText(lr0Parser.goToTableStr());
		        }else{
		            clr1output.setText(lr1Parser.goToTableStr());
		        }
			}
		});
		button_4.setBounds(442, 156, 89, 23);
		...
		button_5.addActionListener(new ActionListener() {
			...
			private void handleAction(ActionEvent e) {
				if(parserKind.equals("LR(0)") || parserKind.equals("SLR(1)")){
		            clr1output.setText(lr0Parser.actionTableStr());
		        }else{
		            clr1output.setText(lr1Parser.actionTableStr());
		        }
			}
		});
		button_5.setBounds(534, 156, 102, 23);
		...
		btnParse.addActionListener(new ActionListener() {
			...
			private void hadleStart(ActionEvent e) {
	            ...
	            String grammarText = clr1input.getText();
		...
		parser.setBounds(56, 157, 58, 20);
		contentPane.add(parser);
		parser.addItem("CLR(1)");
